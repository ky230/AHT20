...
def take_data():
   ...
   for i in range(12):
      ...
      cmd = ['python3','/home/pkumtd/qaqc_jig/python/analyze-waveforms','-o',out_filename,'--slot',i,'--sourceType','sodium','--print-pdfs','/home/pkumtd/plottt/',filename]
...
def step_module(module_i):
   ...
   if stepper_enable.get():
      try:
         #if module_i == 3 and step_lastposition == 2:
            #query(client, "step 1000", 600)
            #query(client, "step 552", 600)
           # print("special stop of motor")
          #  print("step %i done" % module_i)
         #elif module_i == 2 and step_lastposition == 3:
           # query(client, "step -1000", 600)
          #  query(client, "step -552", 600)
         #   print("special stop of motor")
         #   print("step %i done" % module_i)
