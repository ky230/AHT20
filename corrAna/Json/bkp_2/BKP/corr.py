...
# 文件路径
bkp_folder = "/Users/ky230/Desktop/sensor/AHT20/corrAna/Json/bkp_2/BKP/bkp"
...
def process_and_correct_moudle_data(moudle_name, corrections, moudle_4_data):
    input_file_path = os.path.join(bkp_folder, f"{moudle_name}_Origin.txt")
...
# 读取 Moudle_4 的数据
with open(os.path.join(bkp_folder, "Moudle_4_Origin.txt"), 'r') as m4_file:
